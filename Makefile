...
tests: tests.c lib_tar.o
	...
	tar --posix --pax-option delete=".*" --pax-option delete="*time*" --no-xattrs --no-acl --no-selinux -c dirarchive/testf1.txt dirarchive/testf2.txt dirarchive/testdir dirarchive/myslink>   dirarchive/testarchive.tar
